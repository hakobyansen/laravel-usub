...
use Usub\Http\Middleware\UsubSignOut;
...
class UsubServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/../Http/Middleware/UsubSignOut.php' => app_path('Http/Middleware/UsubSignOut.php'),
        ], 'laravel-usub');
        ...
        {
            $this->app['router']->aliasMiddleware( 'usub_sign_out', UsubSignOut::class );
        }
